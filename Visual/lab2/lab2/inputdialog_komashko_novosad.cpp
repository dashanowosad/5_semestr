...
InputDialog_Komashko_Novosad::InputDialog_Komashko_Novosad(QWidget *pwgt):QDialog(pwgt)
{
    ...
    QPushButton *pcmdCancel = new QPushButton("&Cansel");
...
QString InputDialog_Komashko_Novosad::firstName() const{
    return m_ptxtFirstName->text();
}
QString InputDialog_Komashko_Novosad::lastName() const{
